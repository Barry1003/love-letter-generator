    ...
    <div style={{ background: t.card, border: `1px solid ${t.border}`, boxShadow: "4px 8px 48px rgba(0,0,0,0.18)" }}>
      ...
      <div style={{ padding: "36px 26px 44px" }}>
        ...
        {card.message && (
          <p
            className="font-hand"
            style={{ fontSize: 23, fontWeight: 500, color: t.text, lineHeight: 1.6, margin: "0 0 32px", whiteSpace: "pre-wrap", overflowWrap: "break-word", ...anim("fade-in-up 0.6s ease 0.75s both") }}
          >
            {card.message}
          </p>
        )}
